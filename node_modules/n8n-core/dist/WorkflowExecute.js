                    ...
                    for (let tryIndex = 0; tryIndex < maxTries; tryIndex++) {
                        try {
                            ...
                            if (pinData && !executionNode.disabled && pinData[executionNode.name] !== undefined) {
                                ...
                                const runNodeData = await workflow.runNode(executionData, this.runExecutionData, runIndex, this.additionalData, NodeExecuteFunctions, this.mode, this.abortController.signal);
