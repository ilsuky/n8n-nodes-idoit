    ...
    async runNode(inputData, runIndex, nodeType, executeData, nodeExecuteFunctions, credentialsDecrypted, abortSignal) {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            try {
                ...
                throw new node_api_error_1.NodeApiError(this.node, error, {
                    runIndex,
                    itemIndex: i,
    ...
    async runPostReceiveAction(executeSingleFunctions, action, inputData, responseData, parameterValue, itemIndex, runIndex) {
        ...
        if (action.type === 'rootProperty') {
            try {
                ...
                throw new node_operation_error_1.NodeOperationError(this.node, error, {
                    runIndex,
                    itemIndex,
                    ...
                    do {
                        ...
                        if (properties.rootProperty) {
                            ...
                            if (tempResponseValue === undefined) {
                                throw new node_operation_error_1.NodeOperationError(this.node, `The rootProperty "${properties.rootProperty}" could not be found on item.`, { runIndex, itemIndex });
                            }
