...
class NodeApiError extends node_error_1.NodeError {
    constructor(node, errorResponse, { message, description, httpCode, parseXml, runIndex, itemIndex, level, functionality, messageMapping, } = {}) {
        ...
        if ((errorResponse === null || errorResponse === void 0 ? void 0 : errorResponse.response) &&
            typeof (errorResponse === null || errorResponse === void 0 ? void 0 : errorResponse.response) === 'object' &&
        ...
        if (!this.description) {
            if (parseXml) {
                ...
                this.description = this.findProperty(errorResponse, ERROR_MESSAGE_PROPERTIES, ERROR_NESTING_PROPERTIES);
            }
        }
        if (message) {
