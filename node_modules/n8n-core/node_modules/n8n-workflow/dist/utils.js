...
exports.updateDisplayOptions = exports.removeCircularRefs = exports.isTraversableObject = exports.assert = exports.fileTypeFromMimeType = exports.sleep = exports.jsonStringify = exports.replaceCircularReferences = exports.jsonParse = exports.deepCopy = exports.isObjectEmpty = void 0;
...
const jsonStringify = (obj, options = {}) => {
    return JSON.stringify((options === null || options === void 0 ? void 0 : options.replaceCircularRefs) ? (0, exports.replaceCircularReferences)(obj) : obj);
};
